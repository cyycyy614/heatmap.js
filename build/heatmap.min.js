...
;(function (a, b, c) {
  ...
  var a = { defaultRadius: 40, defaultRenderer: 'canvas2d', defaultGradient: { 0.25: 'rgb(0,0,255)', 0.55: 'rgb(0,255,0)', 0.85: 'yellow', 1: 'rgb(255,0,0)' }, defaultMaxOpacity: 1, defaultMinOpacity: 0, defaultBlur: 0.85, defaultXField: 'x', defaultYField: 'y', defaultValueField: 'value', plugins: {} }
  var b = (function h() {
    var b = function d(a) {
      this._coordinator = {}
      this._data = []
  ...
  var c = (function i() {
    ...
    function d(b) {
      ...
      this.shadowCtx = d.getContext('2d', { willReadFrequently: true })
      this.ctx = e.getContext('2d', { willReadFrequently: true })
